...
The cursor's own bar comes off after ten seconds with nothing pressed, and any key —
...
and the next key acts on exactly the row it would have acted on before it came off.
